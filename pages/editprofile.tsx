        ...
        <section className="max-w-4xl p-6 mx-auto bg-gray-800 rounded-md shadow-md :bg-gray-800 ">
          ...
          <div className="text-center">
            {message == "Auth successsful" && (
              <p className="mt-3 text-green-600  text-green-600">{message}</p>
            )}

            {message && message != "Auth successsful" && (
              <p className="mt-3 text-red-600  text-red-600">{message}</p>
            )}
          </div>
          <form className="py-5 " onSubmit={(e) => submitHandler(e)}>
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
              <div>
                <label className="text-white :text-gray-200">Username</label>
                <input
                  value={name}
              ...
              <div>
                <label className="text-white :text-gray-200">Password</label>
                <input
                  value={password}
